  ...
  return (
    <div className="flex flex-col min-h-screen bg-white px-6 py-12 pb-40 lg:pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
           <h1 className="text-4xl font-black text-[#292828] mb-2">Network Groups</h1>
           <p className="text-[#292828] font-medium text-lg">Collaborate in high-intensity industry clusters.</p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {[
          ...
          <div key={group.name} className="p-10 bg-white border border-[#292828]/10 rounded-[3rem] hover:shadow-3xl hover:border-[#E53935]/10 transition-all group">
             <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                   <h3 className="text-2xl font-bold text-[#292828] mb-1">{group.name}</h3>
                   <p className="text-[12px] font-bold text-[#292828] capitalize">{group.members} Members • Active Now</p>
                </div>
             </div>
             <div className="p-6 bg-[#292828]/5 rounded-2xl mb-8">
                <p className="text-[10px] font-black text-[#292828]/40 uppercase mb-2">Live discussion</p>
             ...
             <button className="w-full py-5 bg-[#292828] text-white rounded-[1.5rem] font-bold text-[11px] uppercase group-hover:bg-[#E53935] transition-all flex items-center justify-center gap-2">Join Discussion <ArrowRight size={18} /></button>
          </div>
        ))}
      </div>
    </div>
