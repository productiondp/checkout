...
const PartnerCard = ({ p, viewMode }: { p: any, viewMode?: "grid" | "list" }) => {
  ...
  if (isBlocked) {
    return (
      <div className={cn(
        ...
        viewMode === "list" ? "rounded-[3rem] h-full min-h-[160px]" : "rounded-[4rem] h-full min-h-[400px] flex-col"
      )}>
        <div className="flex flex-col items-center text-center gap-3">
            <UserX size={32} className="text-slate-400" />
            <div>
               <h3 className="text-xl font-black text-slate-500 uppercase">{p.name}</h3>
               <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Profile Blocked</p>
            </div>
  ...
  if (viewMode === "list") {
    return (
      <div className="group bg-white border border-[#292828]/10 rounded-[3rem] p-8 transition-all hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] flex flex-col md:flex-row items-center justify-between gap-10 relative">
         <div className="absolute left-0 top-0 bottom-0 w-2 bg-[#E53935] opacity-0 group-hover:opacity-100 transition-opacity rounded-l-[3rem]" />
         <div className="flex items-center gap-10 flex-1 min-w-0">
            ...
            <div className="min-w-0">
               ...
               <p className="text-[13px] font-black text-[#292828]/40 uppercase tracking-[0.2em] mb-6 truncate">{p.role} @ {p.company}</p>
         ...
         <div className="flex gap-3 shrink-0 items-center">
            <Link href={`/profile/${p.id}`} className="px-8 h-12 md:h-16 flex items-center justify-center bg-[#292828] text-white rounded-[1.5rem] font-black text-[12px] uppercase shadow-2xl hover:bg-[#E53935] active:scale-95 transition-all">View Profile</Link>
            <Link href={`/chat?user=${p.id}`} className="h-12 w-12 md:h-16 md:w-16 flex items-center justify-center bg-[#292828]/5 rounded-[1.5rem] text-[#292828] hover:bg-[#292828]/10 hover:shadow-xl transition-all"><MessageSquare size={24} /></Link>
            <div className="relative group/menu">
               <button className="h-12 w-12 md:h-16 md:w-16 flex items-center justify-center text-[#292828]/40 hover:text-[#292828] hover:bg-slate-50 rounded-[1.5rem] transition-all">
  ...
  return (
    <div className="group relative bg-white border border-[#292828]/10 rounded-[4rem] transition-all duration-700 hover:shadow-[0_80px_160px_-40px_rgba(0,0,0,0.2)] hover:border-[#E53935]/30 flex flex-col h-full">
       ...
       <div className="p-8 relative z-10 flex flex-col h-full">
          ...
          <div className="flex justify-between items-start mb-6">
             <div className="relative">
                <div className="h-28 w-28 rounded-[2.5rem] overflow-hidden p-1 bg-white border border-[#292828]/5 shadow-2xl group-hover:rotate-6 transition-transform duration-500">
          ...
          <div className="mb-6">
             ...
             <p className="text-[11px] font-black text-[#292828]/40 uppercase tracking-[0.2em] mb-4">{p.role} @ {p.company}</p>
          ...
          <div className="p-6 bg-slate-50/50 rounded-[2rem] border border-[#292828]/5 mb-8 group-hover:bg-white transition-all duration-500 relative overflow-hidden flex-1">
             <div className="absolute top-0 right-0 w-1 bg-[#E53935] h-0 group-hover:h-full transition-all duration-700" />
             <p className="text-[9px] font-black text-[#292828]/30 uppercase tracking-[0.2em] mb-3">About</p>
...
const CompactSuggestedCard = ({ p }: { p: any }) => (
  <div className="min-w-[85vw] md:min-w-[400px] lg:min-w-[calc(33.333%-1.5rem)] bg-white border border-[#292828]/10 rounded-[2.5rem] p-6 transition-all hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] hover:border-[#E53935]/30 snap-start flex gap-6 items-center group relative overflow-hidden cursor-pointer">
     <div className="absolute left-0 top-0 bottom-0 w-2 bg-[#E53935] opacity-0 group-hover:opacity-100 transition-opacity rounded-l-[2.5rem]" />
     ...
     <div className="flex-1 min-w-0">
        ...
        <p className="text-[11px] font-black text-[#292828]/40 uppercase tracking-[0.1em] mb-4 truncate">{p.role}</p>
        <div className="flex items-center gap-2">
           ...
           <span className="px-3 py-1 bg-[#292828]/5 text-[#292828] rounded-lg text-[9px] font-black uppercase tracking-widest truncate max-w-[120px]">
              {p.city}
           </span>
        </div>
     </div>
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFF] relative overflow-x-hidden selection:bg-[#E53935]/10">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 lg:px-12 py-12">
         ...
         <div className="mb-20">
            <div className="flex items-center gap-5 mb-12">
               <div className="h-16 w-16 bg-gradient-to-br from-[#E53935] to-[#C62828] text-white rounded-[2rem] flex items-center justify-center shadow-[0_25px_50px_-12px_rgba(229,57,53,0.4)]">
                  <Target size={32} />
               </div>
               <div>
         ...
         <div id="discovery-hub" className="mb-24">
            {/* FILTER BAR */}
            <div className="sticky top-6 z-40 mb-12 bg-white/70 backdrop-blur-xl border border-slate-200/60 rounded-[1.5rem] p-3 shadow-sm flex items-center gap-4 transition-all overflow-x-auto no-scrollbar">
               <div className="flex items-center gap-1 px-1">
                  {["All", "My Network", "Founders", "Investors", "Logistics", "MSME"].map(tab => (
                    <button 
                     ...
                     className={cn(
                       "h-12 px-6 rounded-[1rem] text-[12px] font-bold uppercase transition-all whitespace-nowrap",
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 mt-4">
               ...
               <div className="flex flex-wrap items-center justify-end gap-4 w-full">
                  ...
                  <div className="relative h-12 bg-white border border-slate-200/60 rounded-xl px-6 flex items-center gap-3 min-w-[200px] shadow-sm hover:border-[#E53935]/40 transition-all">
                     <span className="text-[10px] font-black text-[#292828]/40 uppercase tracking-widest leading-none mt-0.5">Sort:</span>
                     <select 
                       value={sortBy}
      ...
      <div className="px-6 lg:px-12 mb-16 relative z-10">
         <div className="max-w-[1600px] mx-auto bg-gradient-to-br from-[#292828] to-[#121212] rounded-[5rem] p-12 lg:p-32 relative overflow-hidden group shadow-[0_80px_160px_-40px_rgba(41,40,40,0.5)] border border-white/5">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-24">
               <div className="max-w-2xl text-center lg:text-left space-y-10">
                  <div className="inline-flex items-center gap-3 px-6 py-2 bg-white/5 border border-white/10 rounded-full">
                     ...
                     <span className="text-[10px] font-black text-[#E53935] uppercase tracking-[0.4em]">Grow Your Network</span>
                  </div>
                  <h3 className="text-4xl lg:text-7xl font-black text-white uppercase leading-[0.9] tracking-tighter">
                     Expand your <br/>
                  ...
                  <Link 
                    href="/profile" 
                    className="inline-flex items-center gap-6 px-16 py-8 bg-[#E53935] text-white rounded-[2.5rem] font-black text-[13px] uppercase shadow-[0_30px_60px_-15px_rgba(229,57,53,0.5)] hover:bg-white hover:text-[#292828] transition-all transform hover:-translate-y-2 active:scale-95"
                  >
               ...
               <div className="relative h-64 w-64 lg:h-[450px] lg:w-[450px] flex items-center justify-center">
                  ...
                  <div className="relative z-10 p-12 bg-white/5 backdrop-blur-3xl rounded-[4rem] border border-white/5 shadow-2xl rotate-12 group-hover:rotate-0 transition-transform duration-1000">
