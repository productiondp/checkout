...
export default function DesktopSidebar() {
 ...
 <h3 className="px-4 text-[10px] font-bold uppercase text-[#292828]/30 ">
 {group.group}
 </h3>
 ...
 {item.badge && (
 <span className="ml-auto h-5 px-2 rounded-md bg-[#E53935] text-white text-[10px] font-bold flex items-center justify-center shadow-lg">
 {item.badge}
 </span>
 )}
 ...
 <div>
 <p className="text-[11px] font-bold text-[#292828] uppercase leading-none mb-1">Elite Level</p>
 <p className="text-[9px] font-bold text-[#292828]/40 uppercase">Global Verified Hub</p>
 </div>
 </div>

 <div className="space-y-3 relative z-10">
 <div className="flex justify-between text-[9px] font-bold text-[#292828]/30 uppercase">
