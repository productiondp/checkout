    ...
    <div className="flex flex-col min-h-screen bg-[#FDFDFF]">
      <main className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-12">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {/* MAIN BALANCE CARD */}
            <div className="lg:col-span-2 bg-[#E53935] rounded-[2.275rem] p-12 lg:p-16 text-white shadow-3xl shadow-red-500/30 flex flex-col justify-between relative overflow-hidden group">
               ...
               <div className="relative z-10 w-full">
                  <div className="flex items-center justify-between mb-16">
                     <p className="text-[14px] font-bold uppercase text-white/60">Checkout Business Wallet</p>
            ...
            {/* QUICK STATS */}
            <div className="bg-white rounded-[2.275rem] p-10 border border-[#292828]/10 shadow-xl shadow-slate-200/20 flex flex-col justify-between">
         ...
         <div className="bg-white rounded-[2.275rem] p-12 border border-[#292828]/10 shadow-sm overflow-hidden pb-20">
