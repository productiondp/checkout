...
export default function PremiumMarketplacePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white lg:bg-[#FDFDFF] selection:bg-[#E53935]/10 overscroll-none">
      ...
      {/* 1. CINEMATIC HEADER */}
      <div className="bg-[#292828] px-6 lg:px-12 py-12 lg:py-20 relative overflow-hidden">
      ...
      <div className="px-6 lg:px-12 py-10">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-40">
            {filteredItems.map(item => (
              <div key={item.id} className="group bg-white border border-[#292828]/10 rounded-[3.5rem] p-1.5 transition-all hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] hover:border-[#E53935]/10 overflow-hidden">
                 ...
                 <div className="px-8 pb-8 flex items-center gap-4">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[10px] font-black text-[#292828] uppercase">Hub Delivery</span>
                    </div>
                    <div className="h-1 w-1 bg-slate-200 rounded-full" />
                    <div className="flex items-center gap-2">
                       <BadgeCheck size={14} className="text-blue-500" />
                       <span className="text-[10px] font-black text-[#292828] uppercase">Certified</span>
                    </div>
                 </div>
              </div>
            ))}
