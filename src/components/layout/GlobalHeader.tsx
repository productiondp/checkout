        ...
        <div className="relative border-l border-[#292828]/10 pl-4 lg:pl-6 ml-0 lg:ml-1 hidden sm:block">
           ...
           {isLocationOpen && (
             <div className="absolute top-[130%] left-0 lg:left-6 w-56 bg-white rounded-2xl shadow-4xl border border-[#292828]/10 p-3 animate-in fade-in slide-in-from-top-2">
                <p className="px-3 py-2 text-[10px] font-bold text-[#292828] uppercase border-b border-[#292828]/5 mb-2">Change City</p>
      ...
      <div className="flex items-center gap-2 lg:gap-3 flex-1 justify-end">
         ...
         <div className="relative">
            <Link 
              href="/profile"
              onClick={(e) => {
                // Prevent dropdown toggle if clicking specifically for navigation
                // Actually, let's just make it navigate and let the user handle the dropdown separately if they want
              }}
            ...
            {isProfileOpen && (
              <div className="absolute top-[130%] right-0 w-64 bg-white rounded-3xl shadow-4xl border border-[#292828]/10 p-3 animate-in fade-in slide-in-from-top-2">
                 <div className="px-4 py-4 mb-2 border-b border-[#292828]/5">
                    <p className="text-[14px] font-bold text-[#292828] leading-tight">Ahmad Fawaid</p>
                    <p className="text-[11px] font-medium text-[#292828] capitalize">Verified Profile</p>
                 </div>
