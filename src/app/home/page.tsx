...
export default function CheckoutHomeFeed() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-6 lg:py-8 space-y-6 selection:bg-[#E53935]/10">
      ...
      {/* 1. COMPOSER */}
      <section className="w-full max-w-[730px] mx-auto bg-white rounded-[24px] p-2 border border-[#292828]/10 shadow-premium group transition-all hover:border-[#292828]/20">
      ...
      {!isVerified && (
         <div className="w-full max-w-[730px] mx-auto bg-[#E53935] text-white p-6 lg:p-8 rounded-[24px] lg:rounded-[32px] mb-8 shadow-2xl animate-in slide-in-from-top-4 duration-700 flex flex-col lg:flex-row items-center justify-between group relative overflow-hidden text-center lg:text-left gap-6">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl translate-x-1/2 -translate-y-1/2" />
            <div className="flex flex-col lg:flex-row items-center gap-6 relative z-10 w-full">
               <div className="h-16 w-16 bg-white/20 rounded-2xl flex items-center justify-center shrink-0 backdrop-blur-md group-hover:scale-110 transition-transform">
      ...
      {/* 2. QUICK FILTERS */}
      <div className="w-full max-w-[730px] mx-auto flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
         {SMART_FILTERS.map(f => (
           <button 
             key={f.id}
